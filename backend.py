...
import pandas as pd
import os, json, datetime, traceback, ssl, smtplib
...
COMPANY_URLS = [
    "https://sozhaa.ai/",
    "https://sozhaa.ai/about-us",
    "https://sozhaa.ai/services",
    "https://sozhaa.ai/ai-agents",
    "https://sozhaa.ai/solutions",
    "https://sozhaa.ai/industries",
...
async def chat_endpoint(payload: ChatPayload, background_tasks: BackgroundTasks):
    ...
    if "[User ended the chat]" in user_msg:
        assistant_text = "✅ Thank you for chatting with Sozhaa AI 🚀\nOur team will contact you soon."
        ...
        if user_phone:
            thank_msg = "✅ Thanks for contacting Sozhaa AI. Our team will contact you soon 🚀"
        ...
        if payload.user_details.get("email"):
            ...
            send_email_with_attachment(payload.user_details["email"], "Sozhaa AI — Chat Summary", thank_you_html, TRANSCRIPT_EXCEL)
